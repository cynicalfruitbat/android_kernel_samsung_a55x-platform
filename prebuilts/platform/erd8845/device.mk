...
CONF_PATH_BASE := device/samsung/erd8845/conf
...
PRODUCT_COPY_FILES += device/samsung/erd8845/conf/init.insmod.sh:/vendor/bin/init.insmod.sh
...
BOARD_GROUP_BASIC_PARTITION_LIST := system vendor vendor_dlkm system_dlkm
endif
...
DEVICE_MANIFEST_FILE := device/samsung/erd8845/manifest_ab.xml
else
DEVICE_MANIFEST_FILE := device/samsung/erd8845/manifest.xml
endif
DEVICE_MATRIX_FILE := device/samsung/erd8845/compatibility_matrix.xml
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE := device/samsung/erd8845/framework_compatibility_matrix.xml
DEVICE_PACKAGE_OVERLAYS += device/samsung/erd8845/overlay

# Init files
PRODUCT_COPY_FILES += \
	$(CONF_PATH_BASE)/init.s5e8845.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.$(TARGET_SOC).rc \
	$(CONF_PATH_BASE)/init.s5e8845.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.$(TARGET_SOC).usb.rc \
	$(CONF_PATH_BASE)/ueventd.s5e8845.rc:$(TARGET_COPY_OUT_VENDOR)/etc/ueventd.rc \
	$(CONF_PATH_BASE)/init.recovery.s5e8845.rc:root/init.recovery.$(TARGET_SOC).rc \
	device/samsung/erd8845/task_profiles.json:$(TARGET_COPY_OUT_VENDOR)/etc/task_profiles.json
	
# performance property
PRODUCT_PROPERTY_OVERRIDES += sys.perf.hmp=4:4
...
ifeq ($(AB_OTA_UPDATER), true)
FSTAB_FILE := fstab.s5e8845.$(BOOTUP_STORAGE).ab
else
FSTAB_FILE := fstab.s5e8845.$(BOOTUP_STORAGE)
endif
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
	$(CONF_PATH_BASE)/init.recovery.s5e8845.rc:$(RECOVERY_TARGET_COPY_OUT_VENDOR_RAMDISK)/init.recovery.$(TARGET_SOC).rc \
	$(CONF_PATH_BASE)/init.s5e8845.usb.rc:$(RECOVERY_TARGET_COPY_OUT_VENDOR_RAMDISK)/etc/init/init.$(TARGET_SOC).usb.rc
...
PRODUCT_SOONG_NAMESPACES += vendor/samsung_slsi/s5e8845/libs
PRODUCT_COPY_FILES += \
	device/samsung/erd8845/handheld_core_hardware.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/handheld_core_hardware.xml \
...
ifeq ($(WITH_32BIT_SUPPORT),true)
#For building 64/32 bit support.
$(call inherit-product, $(SRC_TARGET_DIR)/product/core_64_bit.mk)
else
#For building 64-bit only support.
...
PRODUCT_COPY_FILES += \
  device/samsung/erd8845/public.libraries.txt:$(TARGET_COPY_OUT_VENDOR)/etc/public.libraries.txt
...
PRODUCT_PACKAGES += \
	$(BOARD_LIBHDR_PLUGIN_MAIN)\
	$(BOARD_LIBHDR_PLUGIN_SUB)

# EPIC
PRODUCT_SOONG_NAMESPACES += device/samsung/erd8845/epic
PRODUCT_PACKAGES += \
       epic libems_service libgmc libepic_helper

PRODUCT_COPY_FILES += \
       device/samsung/erd8845/epic/epic.json:$(TARGET_COPY_OUT_VENDOR)/etc/epic.json \
       device/samsung/erd8845/epic/ems.json:$(TARGET_COPY_OUT_VENDOR)/etc/ems.json \
       device/samsung/erd8845/epic/ems_parameter.json:$(TARGET_COPY_OUT_VENDOR)/etc/ems_parameter.json
...
ifneq (,$(findstring erd8845, $(TARGET_PRODUCT)))
PRODUCT_VENDOR_PROPERTIES += \
...
# Profiler
PRODUCT_SOONG_NAMESPACES += device/samsung/erd8845/profiler
PRODUCT_PACKAGES += \
       gflow gperf libexynos_profiler libexynos_logger
PRODUCT_COPY_FILES += \
       device/samsung/erd8845/profiler/gperf_version.txt:$(TARGET_COPY_OUT_VENDOR)/etc/gperf_version.txt \
...
PRODUCT_PACKAGES += \
    ...
    android.hardware.fastboot@1.1-impl-mock.s5e8845
...
# VPL
PRODUCT_COPY_FILES += \
    device/samsung/erd8845/firmware/camera/libvpl/default_configuration.flm.cfg.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/default_configuration.flm.cfg.bin \
    device/samsung/erd8845/firmware/camera/libvpl/secure_configuration.flm.cfg.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/secure_configuration.flm.cfg.bin \
    device/samsung/erd8845/firmware/camera/libvpl/OD_V3.4.10_11_17_QVGA_ROSE_ENN_BGRA.nnc:$(TARGET_COPY_OUT_VENDOR)/firmware/OD_V3.4.10_11_17_QVGA_ROSE_ENN_BGRA.nnc \
    device/samsung/erd8845/firmware/camera/libvpl/OD_V3.5.3_06_12_VGA_ROSE_ENN_BGRA.nnc:$(TARGET_COPY_OUT_VENDOR)/firmware/OD_V3.5.3_06_12_VGA_ROSE_ENN_BGRA.nnc

# WLAN configuration
# device specific wpa_supplicant.conf
#PRODUCT_COPY_FILES += \
#    device/samsung/erd8845/wpa_supplicant.conf:vendor/etc/wifi/wpa_supplicant.conf \
#    device/samsung/erd8845/wifi/p2p_supplicant.conf:vendor/etc/wifi/p2p_supplicant.conf \
#
#PRODUCT_PROPERTY_OVERRIDES += \
...
$(call inherit-product, device/samsung/erd8845/scsc_wlbt.mk)
...
PRODUCT_COPY_FILES += \
    device/samsung/erd8845/wifi/init.insmod.wifi.cfg:/vendor/etc/wifi/init.insmod.wifi.cfg \
    device/samsung/erd8845/wifi/init.exynos.wifi.rc:/vendor/etc/init/init.exynos.wifi.rc \
...
# Exynos GNSS
# $(call inherit-product, vendor/samsung_slsi/gnss/s5e8845/device-gnss.mk)
endif
